...
class User extends Database
{
    ...
    {
        $sql = 'SELECT user_uuid, username, nombre, apellido, telefono, email, photo, rol, fecha, suscripcion, fin_suscripcion, token_fcm_static, premio FROM usuarios WHERE user_uuid = ?';
