...
class Youtube
{
    ...
    public function downloadAndConvertVideo($videoId)
    {
        ...
        $ytDlpCommand = "/var/multimarcas-dev/bin/yt-dlp --format bestaudio[ext=webm] -o " . escapeshellarg("%(title)s.%(ext)s") . " https://www.youtube.com/watch?v=$videoId";
        $ytDlpCommand = escapeshellcmd($ytDlpCommand);
