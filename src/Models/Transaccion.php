...
class Transaccion extends Database
{
    ...
    public function saveTransaction($IdTransaccion, $ResultadoTransaccion, $Monto, $FechaTransaccion, $header_wompi, $wompiHashHeader, $mas)
    {
        ...
        if ($calculatedHash === $wompiHashHeader) {
            if (!$this->existenciaIdTransaccion($IdTransaccion)) {
                ...
                $transaccion = $this->ejecutarConsulta($sql, [$IdTransaccion, $ResultadoTransaccion, $Monto, $FechaTransaccion, $mas]);
                if ($transaccion) {
